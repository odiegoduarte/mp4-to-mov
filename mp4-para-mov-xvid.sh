...
echo -e
print_centered "-"  "-" 
print_centered "> Convertendo vídeo de MP4 para MOV XVID <"
print_centered "-"  "-" 
echo -e
...
for vid in *.mp4; do  
noext="${vid%.mp4}"    
ffmpeg -i "$vid" -acodec pcm_s16le -vcodec libxvid -q:v 1 "${noext// /_}.mov"
mv "$vid" "$origdir"
...
echo -e
print_centered "-"  "-" 
print_centered "> Convertido para .MOV preset XVID <"
print_centered "-"  "-" 
echo -e